...
frac1_str = input("Введите первую строку вида “a/b” - дробь с числителем и знаменателем из целых чисел: ")
frac2_str = input("Введите вторую строку вида “a/b” - дробь с числителем и знаменателем из целых чисел: ")
